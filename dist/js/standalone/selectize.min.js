...
b.trigger("destroy"),b.off(),b.$wrapper.remove(),b.$dropdown.remove(),b.$input.html("").append(d.$children).removeAttr("tabindex").removeClass("selectized").attr({tabindex:d.tabindex}).show(),b.$control_input.removeData("grow"),b.$input.removeData("selectize"),a(window).off(c),a(document).off(c),a(document.body).off(c),delete b.$input[0].selectize},render:function(a,b){var c,d,e="",f=!1,g=this,h=/^[\t ]*<([a-z][a-z0-9\-_]*(?:\:[a-z][a-z0-9\-_]*)?)/i;return("option"===a||"item"===a)&&(c=y(b[g.settings.valueField]),f=!!c),f&&(x(g.renderCache[a])||(g.renderCache[a]={}),g.renderCache[a].hasOwnProperty(c))?g.renderCache[a][c]:(e=g.settings.render[a].apply(this,[b,z]),("option"===a||"option_create"===a)&&(e=e.replace(h,"<$1 data-selectable")),"optgroup"===a&&(d=b[g.settings.optgroupValueField]||"",e=e.replace(h,'<$1 data-group="'+A(z(d))+'"')),("option"===a||"item"===a)&&(e=e.replace(h,'<$1 data-value="'+A(z(c||""))+'"')),f&&(g.renderCache[a][c]=e),e)},clearCache:function(a){var b=this;"undefined"==typeof a?b.renderCache={}:delete b.renderCache[a]}}),L.count=0,L.defaults={plugins:[],delimiter:",",persist:!0,diacritics:!0,create:!1,createOnBlur:!1,createFilter:null,highlight:!0,openOnFocus:!0,maxOptions:1e3,maxItems:null,hideSelected:null,addPrecedence:!1,selectOnTab:!1,preload:!1,scrollDuration:60,loadThrottle:300,dataAttr:"data-data",optgroupField:"optgroup",valueField:"value",labelField:"text",optgroupLabelField:"label",optgroupValueField:"value",optgroupOrder:null,sortField:"$order",searchField:["text"],searchConjunction:"and",mode:null,wrapperClass:"selectize-control",inputClass:"selectize-input",dropdownClass:"selectize-dropdown",dropdownContentClass:"selectize-dropdown-content",dropdownParent:null,render:{}},a.fn.selectize=function(b){var c=a.fn.selectize.defaults,d=a.extend({},c,b),e=d.dataAttr,f=d.labelField,g=d.valueField,h=d.optgroupField,i=d.optgroupLabelField,j=d.optgroupValueField,k=function(b,c){var e,h,i,j,k=a.trim(b.val()||"");if(k.length){for(i=k.split(d.delimiter),e=0,h=i.length;h>e;e++)j={},j[f]=i[e],j[g]=i[e],c.options[i[e]]=j;c.items=i}},l=function(b,c){var d,k,l,m,n=0,o=c.options,p=function(a){var b=e&&a.attr(e);return"string"==typeof b&&b.length?JSON.parse(b):null},q=function(b,d){var e,i;if(b=a(b),e=b.attr("value")||"",e.length){if(o.hasOwnProperty(e))return void(d&&(o[e].optgroup?a.isArray(o[e].optgroup)?o[e].optgroup.push(d):o[e].optgroup=[o[e].optgroup,d]:o[e].optgroup=d));i=p(b)||{},i[f]=i[f]||b.text(),i[g]=i[g]||e,i[h]=i[h]||d,i.$order=++n,o[e]=i,b.is(":selected")&&c.items.push(e)}},r=function(b){var d,e,f,g,h;for(b=a(b),f=b.attr("label"),f&&(g=p(b)||{},g[i]=f,g[j]=f,c.optgroups[f]=g),h=a("option",b),d=0,e=h.length;e>d;d++)q(h[d],f)};for(c.maxItems=b.attr("multiple")?null:1,m=b.children(),d=0,k=m.length;k>d;d++)l=m[d].tagName.toLowerCase(),"optgroup"===l?r(m[d]):"option"===l&&q(m[d])};return this.each(function(){if(!this.selectize){var d,e=a(this),f=this.tagName.toLowerCase(),g={placeholder:e.children('option[value=""]').text()||e.attr("placeholder"),options:{},optgroups:{},items:[]};"select"===f?l(e,g):k(e,g),d=new L(e,a.extend(!0,{},c,g,b))}})},a.fn.selectize.defaults=L.defaults,L.define("drag_drop",function(){if(!a.fn.sortable)throw new Error('The "drag_drop" plugin requires jQuery UI "sortable".');if("multi"===this.settings.mode){var b=this;b.lock=function(){var a=b.lock;return function(){var c=b.$control.data("sortable");return c&&c.disable(),a.apply(b,arguments)}}(),b.unlock=function(){var a=b.unlock;return function(){var c=b.$control.data("sortable");return c&&c.enable(),a.apply(b,arguments)}}(),b.setup=function(){var c=b.setup;return function(){c.apply(this,arguments);var d=b.$control.sortable({items:"[data-value]",forcePlaceholderSize:!0,disabled:b.isLocked,start:function(a,b){b.placeholder.css("width",b.helper.css("width")),d.css({overflow:"visible"})},stop:function(){d.css({overflow:"hidden"});var c=b.$activeItems?b.$activeItems.slice():null,e=[];d.children("[data-value]").each(function(){e.push(a(this).attr("data-value"))}),b.setValue(e),b.setActiveItem(c)}})}}()}}),L.define("dropdown_header",function(b){var c=this;b=a.extend({title:"Untitled",headerClass:"selectize-dropdown-header",titleRowClass:"selectize-dropdown-header-title",labelClass:"selectize-dropdown-header-label",closeClass:"selectize-dropdown-header-close",html:function(a){return'<div class="'+a.headerClass+'"><div class="'+a.titleRowClass+'"><span class="'+a.labelClass+'">'+a.title+'</span><a href="javascript:void(0)" class="'+a.closeClass+'">&times;</a></div></div>'}},b),c.setup=function(){var d=c.setup;return function(){d.apply(c,arguments),c.$dropdown_header=a(b.html(b)),c.$dropdown.prepend(c.$dropdown_header)}}()}),L.define("infinite_scroll",function(b){var c,d;if(null!=this.settings.load)throw new Error('Setting "load" must be passed to "infinite_scroll" plugin');if(null!=this.settings.score)throw new Error('Setting "score" is invalid with "infinite_scroll" plugin');return null==b.loadMoreLabel&&(b.loadMoreLabel="Loading more results..."),null==b.distanceToAutoload&&(b.distanceToAutoload=20),null==b.scoreValueField&&(b.scoreValueField="score"),this.settings.score=function(a){var b;return b=function(b){return function(c){return null!=b.cachedScore[a]?b.cachedScore[a][c[b.settings.valueField]]||0:0}}(this)},c=0,this.loadedSearchePages={},this.cachedScore={},this.emptyQueryResults=[],this.cachedLoadedCount={},this.cachedLoadedCount[""]=0,this.setup=function(c){return function(){var d;return d=c.setup,function(){var c,e,f;d.apply(this,arguments),this.$autoload_on_scroll=a("<div>"),this.$autoload_on_scroll.addClass("selectize-autoload-more"),this.$autoload_on_scroll.text(b.loadMoreLabel),this.$autoload_on_scroll.hide(),f=this.options;for(c in f)e=f[c],this.cachedLoadedCount[""]++,this.emptyQueryResults.push({id:c,score:1});return this.$dropdown_content.scroll(function(a){return function(){return a.refreshAutoload()}}(this)),this.on("dropdown_open",function(){return this.computeContentHeight(),this.refreshAutoload()}),this.on("load",function(a){return function(){return a.refreshAutoload()}}(this))}}}(this)(),d=function(a){return function(c){return a.loadedSearchePages[c].loading=!0,a.load(function(a){return b.load.call(this,c,this.loadedSearchePages[c].page,function(d){return function(e,f){var g,h,i,j,k,l,m,n;if(d.loadedSearchePages[c].loading=!1,null==(i=d.cachedLoadedCount)[c]&&(i[c]=0),d.cachedLoadedCount[c]+=e.length,c.length)for(null==(j=d.cachedScore)[c]&&(j[c]={}),k=0,m=e.length;m>k;k++)g=e[k],h=g[b.scoreValueField],d.cachedScore[c][g[d.settings.valueField]]=h;else for(l=0,n=e.length;n>l;l++)g=e[l],d.emptyQueryResults.push({id:g[d.settings.valueField],score:1});return c===d.lastQuery&&(d.updateScore=!0),a.apply(d,arguments),d.updateScore=!1,d.$autoload_on_scroll.hide(),f?d.loadedSearchePages[c].needMore=!1:void 0}}(this))})}}(this),this.onSearchChange=function(){return function(){return function(a){var c;return c=b.load,null!=c?this.loadedSearchePages.hasOwnProperty(a)?this.refreshAutoload():(this.loadedSearchePages[a]={page:1,needMore:!0,loading:!1},d(a)):void 0}}}(this)(),this.refreshAutoload=function(a){return function(){var e;if(null!=a.lastQuery&&a.isOpen&&null!=a.loadedSearchePages[a.lastQuery]&&!a.loadedSearchePages[a.lastQuery].loading&&a.loadedSearchePages[a.lastQuery].needMore)return a.cachedLoadedCount[a.lastQuery]!==a.currentResults.total?void(a.loadedSearchePages[a.lastQuery].needMore=!1):(e=c-a.$dropdown_content.scrollTop(),e<b.distanceToAutoload?(a.$autoload_on_scroll.show(),a.loadedSearchePages[a.lastQuery].page++,d(a.lastQuery)):void 0)}}(this),this.computeContentHeight=function(a){return function(){var b;return b=a.$dropdown_content,c=b.prop("scrollHeight")-b.height()}}(this),this.refreshOptions=function(a){return function(){var b;return b=a.refreshOptions,function(){return b.apply(this,arguments),this.$dropdown_content.append(this.$autoload_on_scroll),this.computeContentHeight()}}}(this)(),this.search=function(a){return function(){var b;return b=a.search,function(a){return a.length?b.apply(this,arguments):(this.lastQuery="",this.currentResults={items:this.emptyQueryResults,total:this.cachedLoadedCount[""],query:""})}}}(this)(),this.clearOptions=function(a){return function(){var b;return b=a.clearOptions,function(){return b.apply(this,arguments)}}}(this)()}),L.define("optgroup_columns",function(b){var c=this;b=a.extend({equalizeWidth:!0,equalizeHeight:!0},b),this.getAdjacentOption=function(b,c){var d=b.closest("[data-group]").find("[data-selectable]"),e=d.index(b)+c;return e>=0&&e<d.length?d.eq(e):a()},this.onKeyDown=function(){var a=c.onKeyDown;return function(b){var d,e,f,g;return!this.isOpen||b.keyCode!==j&&b.keyCode!==m?a.apply(this,arguments):(c.ignoreHover=!0,g=this.$activeOption.closest("[data-group]"),d=g.find("[data-selectable]").index(this.$activeOption),g=b.keyCode===j?g.prev("[data-group]"):g.next("[data-group]"),f=g.find("[data-selectable]"),e=f.eq(Math.min(f.length-1,d)),void(e.length&&this.setActiveOption(e)))}}();var d=function(){var a,b=d.width,c=document;return"undefined"==typeof b&&(a=c.createElement("div"),a.innerHTML='<div style="width:50px;height:50px;position:absolute;left:-50px;top:-50px;overflow:auto;"><div style="width:1px;height:100px;"></div></div>',a=a.firstChild,c.body.appendChild(a),b=d.width=a.offsetWidth-a.clientWidth,c.body.removeChild(a)),b},e=function(){var e,f,g,h,i,j,k;if(k=a("[data-group]",c.$dropdown_content),f=k.length,f&&c.$dropdown_content.width()){if(b.equalizeHeight){for(g=0,e=0;f>e;e++)g=Math.max(g,k.eq(e).height());k.css({height:g})}b.equalizeWidth&&(j=c.$dropdown_content.innerWidth()-d(),h=Math.round(j/f),k.css({width:h}),f>1&&(i=j-h*(f-1),k.eq(f-1).css({width:i})))}};(b.equalizeHeight||b.equalizeWidth)&&(B.after(this,"positionDropdown",e),B.after(this,"refreshOptions",e))}),L.define("remove_button",function(b){if("single"!==this.settings.mode){b=a.extend({label:"&times;",title:"Remove",className:"remove",append:!0},b);var c=this,d='<a href="javascript:void(0)" class="'+b.className+'" tabindex="-1" title="'+z(b.title)+'">'+b.label+"</a>",e=function(a,b){var c=a.search(/(<\/[^>]+>\s*)$/);return a.substring(0,c)+b+a.substring(c)};this.setup=function(){var f=c.setup;return function(){if(b.append){var g=c.settings.render.item;c.settings.render.item=function(){return e(g.apply(this,arguments),d)}}f.apply(this,arguments),this.$control.on("click","."+b.className,function(b){if(b.preventDefault(),!c.isLocked){var d=a(b.currentTarget).parent();c.setActiveItem(d),c.deleteSelection()&&c.setCaret(c.items.length)}})}}()}}),L.define("restore_on_backspace",function(a){var b=this;a.text=a.text||function(a){return a[this.settings.labelField]},this.onKeyDown=function(){var c=b.onKeyDown;return function(b){var d,e;return b.keyCode===p&&""===this.$control_input.val()&&!this.$activeItems.length&&(d=this.caretPos-1,d>=0&&d<this.items.length)?(e=this.options[this.items[d]],this.deleteSelection(b)&&(this.setTextboxValue(a.text.apply(this,[e])),this.refreshOptions(!0)),void b.preventDefault()):c.apply(this,arguments)}}()}),L});